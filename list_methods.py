...
#myListOfNumbers.sort() # Sorts the original list 3
#myListOfNumbers.reverse() # Reverses the original list 4
...
myListOfNumbers.remove(21) # Removes a given item from the list
print(myListOfNumbers)